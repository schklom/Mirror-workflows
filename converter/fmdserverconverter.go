...
func (u *OLDIO) GetLocation(id string, pos int) ([]byte, error) {
	userLocationPath := filepath.Join(u.getUserDir(id), locationDir)
...
func (u *OLDIO) GetPrivateKey(id string) (string, error) {
...
func (u *OLDIO) GetUserInfo(id string) (UserInfo, error) {
	userFile := filepath.Join(u.getUserDir(id), userInfoFile)
