...
- 🌍 **13 languages** — full UI translation (EN, DE, ES, FR, IT, Portuguese (Portugal), Portuguese (Brazil), PL, TR, RU, ZH, KO, HI); exercise instructions localized in 10 of them, loaded on demand so the app stays fast
